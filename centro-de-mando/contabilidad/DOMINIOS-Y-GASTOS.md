...
- **2026-09-15:** tercer día seguido con el mismo bloqueo: `WebFetch`
  ...
  registro real.
- **2026-09-16 (hoy):** cuarto día seguido con el mismo bloqueo: `WebFetch`
  a `drakhthar.com/aldric.html` y a `laiayjudit.com` → mismo error
  ...
  registrante real. Ninguna fecha de esta tabla se ha modificado hoy —
